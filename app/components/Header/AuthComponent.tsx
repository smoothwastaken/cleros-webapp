    ...
    <div>
      { user ? (
        <div className='flex items-center gap-2 transition-all duration-500'>
          ...
          {logPopUp ? (
            <div className='absolute z-40 w-full h-full bg-black bg-opacity-40 inset-0 bg-clip-padding' style={{backdropFilter: 'blur(2px)'}}>
              <div className='absolute z-50 w-3/6 h-3/6 bg-transparent inset-1/4 rounded-xl border-gray-700 border-[1px] p-5'>
